...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div className={`mt-4 sm:mt-5 h-1 w-16 rounded-full ${color}`} />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
        <StatCard title="Products" value={stats.products} color="bg-cyan-400" />

        <StatCard title="Orders" value={stats.orders} color="bg-brand-400" />

        <StatCard title="Users" value={stats.users} color="bg-brand-300" />
